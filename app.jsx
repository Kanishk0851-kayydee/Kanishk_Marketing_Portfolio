...
import { Download, Instagram, Linkedin, ArrowRight, TrendingUp, Users, Target, Rocket, PenTool, MonitorPlay, Map } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gray-950 text-gray-100 font-sans selection:bg-pink-500 selection:text-white">
      ...
      <section className="px-6 sm:px-12 lg:px-24 max-w-7xl mx-auto mb-24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 auto-rows-[300px]">
          ...
          {/* Box 1: GD Goenka (Spans 2 columns) */}
          <div className="md:col-span-2 bg-gray-900 border border-gray-800 rounded-3xl overflow-hidden group relative flex flex-col justify-end">
            {/* Replace src with your actual screenshot from public folder, e.g., src="/gd-goenka-shot.jpg" */}
          ...
          <div className="md:col-span-1 bg-gray-900 border border-gray-800 rounded-3xl overflow-hidden group relative flex flex-col justify-end">
             {/* Replace src with your Instagram grid screenshot, e.g., src="/ish-grid.jpg" */}
          ...
          <div className="md:col-span-1 bg-gray-900 border border-gray-800 rounded-3xl overflow-hidden group relative flex flex-col justify-end">
             {/* Replace src with YouTube screenshot, e.g., src="/youtube-channel.jpg" */}
          ...
          <div className="md:col-span-2 bg-gray-900 border border-gray-800 rounded-3xl overflow-hidden group relative flex flex-col justify-end">
             {/* Replace src with Camp Land's End screenshot, e.g., src="/camp-lands-end.jpg" */}
